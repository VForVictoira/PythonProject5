...
btnS = Button(root,text="_",width=3)
btn1 = Button(root,text="1",width=3)
btn2=Button(root,text="2",width=3)
Button(root,text="3",width=3)btn3
btnPButton(root,text="+",width=3)
Button(root,text="0",width=8)btn0=btnD = Button(root,text=".",width=3)btnE = Button(root,text="_",width=3)
lab.grid(row=0,column=0,columnspan=4)btn7.grid(row=1,column=0,padx=5)
