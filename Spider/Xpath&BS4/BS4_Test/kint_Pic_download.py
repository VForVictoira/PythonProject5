...
pic_link = selector.xpath('//p[@class="item-image"]//img/@data-src')
print(pic_link)
final_links = ['https://xx.knit.bid' + link for link in pic_link]
'''
...
'''
file_path2 = os.path.join(main_folder, 'download6.txt')
